...
void
SpectatorBackend::PollConnectionProtocolEvents(void)
{
...
void
SpectatorBackend::OnConnectionProtocolEvent(ConnectionProtocol::Event& evt)
{
	GGPOEvent info;
...
void
SpectatorBackend::OnMsg(int player_id, ConnectionMsg* msg, int len)
{
